...
export default function FlightPage() {
  ...
  useEffect(() => {
    ...
    // Аэропорты
    L.circleMarker([flight.departureAirport.latitude, flight.departureAirport.longitude], {
      radius: 8, color: "#3b82f6", fillColor: "#3b82f6", fillOpacity: 0.9, weight: 2,
    }).addTo(map.current).bindPopup(`🛫 ${flight.departureAirport.name}`);

    L.circleMarker([flight.arrivalAirport.latitude, flight.arrivalAirport.longitude], {
